  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="/show/<?= $pokemon['id'] ?>" class="btn btn-xs btn-neutral">
          ...
          <a href="/edit/<?= $pokemon['id'] ?>" class="btn btn-xs btn-neutral">
          ...
          <a href="/delete/<?= $pokemon['id'] ?>" class="btn btn-xs btn-error">
